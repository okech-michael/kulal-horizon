    ...
    <section className="py-28 md:py-40 bg-secondary/30">
      <div className="container-editorial">
        <div className="flex flex-wrap items-end justify-between gap-6 mb-14">
          ...
          <a href="/journal" target="_blank" rel="noreferrer" className="link-underline text-sm font-medium text-primary">Browse all stories →</a>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-12">
          ...
          >
            <a href={stories[0].href} target="_blank" rel="noreferrer" className="block">
            ...
            {others.map((n, i) => {
              ...
              return (
                <motion.article
                  ...
                  className="group rounded-2xl border border-border/50 bg-card p-4 transition-all hover:shadow-elegant"
                >
                  <a href={story.href} target="_blank" rel="noreferrer" className="flex gap-5 items-center">
